...
while ($dados = mysql_fetch_array($query)) {
    ...
    IF ($permissao_paises_editar==1) {
        ...
        $tpl->OPERACAO_NOME = "Você não tem permissão para editar paises! Contate um administrador!";
    ...
    IF ($permissao_paises_excluir==1) {
        ...
        $tpl->OPERACAO_NOME = "Você não tem permissão para excluir paises! Contate um administrador!";
