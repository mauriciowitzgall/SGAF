...
$tpl->CABECALHO_COLUNA_NOME = "OPERA��ES";
$tpl->block("BLOCK_LISTA_CABECALHO");
...
while ($dados = mysql_fetch_array($query)) {
    ...
    IF ($permissao_paises_editar==1) {
        ...
        $tpl->OPERACAO_NOME = "Você n�o tem permiss�o para editar paises! Contate um administrador!";
    ...
    IF ($permissao_paises_excluir==1) {
        ...
        $tpl->OPERACAO_NOME = "Você n�o tem permiss�o para excluir paises! Contate um administrador!";
