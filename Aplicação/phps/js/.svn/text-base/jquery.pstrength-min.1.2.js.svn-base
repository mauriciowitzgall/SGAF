(function(A){
    A.extend(A.fn,{
        pstrength:function(B){
            var B=A.extend({
                verdects:["Quase Nada Segura","Pouco Segura","Normal","Segura","Muito Segura"],
                colors:["red","red","green","green","green"],
                scores:[10,15,30,40],
                common:["senha","123456","123"],
                minchar:3
            },B);
            return this.each(function(){
                var C=A(this).attr("id");
                //A(this).after("<div class=\"pstrength-minchar\" id=\""+C+"_minchar\">Quantidade mínima de caracteres "+B.minchar+"</div>");
