...
$tpl_titulo->SUBTITULO = "CFOP (Código Fiscal de Operações e Prestações)";
...
//Tuplas
set_time_limit(0);
$sql = "SELECT * FROM nfe_cfop ORDER BY cfop_id";
