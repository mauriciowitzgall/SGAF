...
$saida_horaentrega_convertido=$horaentrega; 
...
while ($cont<=2) {
    ...
    $tpl2->CABECALHO_COLUNA_COLSPAN = "6";
    ...
    $tpl2->LISTA_COLUNA_CLASSE = "";
    $tpl2->LISTA_COLUNA_TAMANHO = "";
    $tpl2->LISTA_COLUNA_VALOR = "$saida_dataentrega_convertido $saida_horaentrega_convertido";
    $tpl2->block("BLOCK_LISTA_COLUNA");    
    $tpl2->block("BLOCK_LISTA");
    $tpl2->LISTA_COLUNA_COLSPAN = "";
    $tpl2->LISTA_COLUNA_ALINHAMENTO = "right";
