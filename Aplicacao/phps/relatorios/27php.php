...
$sql=" 
    SELECT $sql_ano_select $sql_mes_select $sql_dia_select  saimot_nome ,round(sum(saipro_totalpesoliquido),3) as totalpesoliquido
    FROM saidas
    ...
    and sai_status=1
    $sql_where 
    group by sai_saidajustificada $sql_ano_groupby $sql_mes_groupby $sql_dia_groupby    
