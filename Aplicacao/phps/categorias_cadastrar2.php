   ...
   <td colspan="2" align="center" >
   	<?php 
        if ($modal==1) {
            ...
            if ($erro==0) { ?><a class="link" href="categorias_cadastrar.php"><input type="button" value="CADASTRAR MAIS" class="botao fonte3"></a>&nbsp;&nbsp;&nbsp; <a class="link" href="<?php echo "$paginadestino"; ?>"><input type="button" value="CONTINUAR" autofocus class="botao fonte3"></a><?php } 
